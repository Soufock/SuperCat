...
我们非常感谢你为 SuperCat 做出贡献！本指南旨在帮助你以更规范的方式向 SuperCat 提交贡献，因此请务必认真阅读。

## 提交 Issue

在提交 Issue 前，我们建议你先查看 [已有的 Issues](https://github.com/Soufock/supercat/issues)，以避免重复提交。

### 报告问题、故障与漏洞

SuperCat 是一个不断发展的项目。如果你在使用过程中发现问题，并且确信这些问题是由 SuperCat 引起的，欢迎提交 Issue。在提交时，请附带详细的复现步骤和运行环境信息。
...
SuperCat 使用 [pnpm](https://pnpm.io/) 来管理项目依赖。如果你已经安装了npm，以下的命令可以帮助你快速配置开发环境：
...
是一个在线的多语言翻译平台。如果您有兴趣帮助我们翻译 SuperCat 的相关内容，您可以在 Crowdin 上找到 SuperCat 项目，并开始进行翻译工作。

- `src/locales`为[扩展](https://github.com/Soufock/supercat)翻译文件目录
...
SuperCat 使用 ESLint 来规范代码风格，使用 Vitest 来进行单元测试。你可以使用以下命令来运行：
